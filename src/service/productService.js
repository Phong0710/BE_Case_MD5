...
var product_1 = require("../enitity/product");
...
var ProductService = /** @class */ (function () {
    function ProductService() {
        ...
        this.add = function (product) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(product);
        ...
        this.editProduct = function (id, productEdit) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(productEdit);
                        return [4 /*yield*/, data_source_1.AppDataSource.getRepository(product_1.Product)
                                .createQueryBuilder()
